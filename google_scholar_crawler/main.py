...
author: dict = scholarly.search_author_id('dYTCyDoAAAAJ')
...
shieldio_data_mtl = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['dYTCyDoAAAAJ:bEWYMUwI8FkC']['num_citations']}",
}
...
shieldio_data_mnemonics = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['dYTCyDoAAAAJ:k_IJM867U9cC']['num_citations']}",
}
...
shieldio_data_aanets = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['dYTCyDoAAAAJ:u_35RYKgDlwC']['num_citations']}",
}
...
shieldio_data_e3bm = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['dYTCyDoAAAAJ:vV6vV6tmYwMC']['num_citations']}",
}
...
shieldio_data_lst = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['dYTCyDoAAAAJ:TFP_iSt0sucC']['num_citations']}",
}
